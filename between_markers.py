"""
 You are given a string and two markers (the initial and final). You have to find a substringenclosed between
...
def between_markers(text: str, begin: str, end: str) -> str:
    begin = text.find(begin) + len(begin) if begin in text else None
